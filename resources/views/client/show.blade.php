            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="product-details-tab">
                    ...
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <a href="#">
                            <img id="zoom1" src="{{Storage::url($data->img_thumb)}}" data-zoom-image="{{Storage::url($data->img_thumb)}} " alt="big-1">
                        </a>
                    </div>
                ...
                <div class="product_d_right">
                    <form action="#">
                        ...
                        <div class="product_meta">
                            <span>Category: <a href="#">{{ $data->category->name }}</a></span>
                        </div>
                ...
                <div class="product_carousel product_column5 owl-carousel">
                    ...
                    <div class="single_product">
                        <div class="product_name">
                            ...
                            <p class="manufacture_product"><a href="#">{{ $data->slug }}</a></p>
                        </div>
                        <div class="product_thumb">
                            <a class="primary_img" href="product-details.html"><img src="{{Storage::url($data->img_thumb)}}" alt=""></a>
                            <a class="secondary_img" href="product-details.html"><img src="{{Storage::url($data->img_thumb)}}" alt=""></a>
                        ...
                        <div class="product_content">
                            ...
                            <div class="product_footer d-flex align-items-center">
                                ...
                                <div class="price_box">
                                    <span class="regular_price">{{ $data->price_sale }}</span>
                                </div>
